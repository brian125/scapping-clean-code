...
public final class StoredEvent {
    ...
    public DomainEvent deserializeEvent() {
        try {
            ...
            throw new co.com.sofka.peliculas.infra.generic.DeserializeException(e.getCause());
        }
    }

    @Override
    public String toString() {
        return co.com.sofka.peliculas.infra.generic.StoredEventSerializer.instance().serialize(this);
    }
